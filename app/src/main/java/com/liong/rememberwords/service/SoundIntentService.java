package com.liong.rememberwords.service;
...
public class SoundIntentService extends IntentService {
    private static final String TAG = "SoundIntentService";
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            if (ACTION_MUSIC.equals(action)){
                handleActionMusic(intent.getStringExtra("soundPath"));
            }
        }
    }
     ...
     * 该服务执行的操作用来播放背景音乐
     */
    private void handleActionMusic(String s) {
